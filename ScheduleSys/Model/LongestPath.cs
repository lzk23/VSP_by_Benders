...
namespace ScheduleSys.Model
{
    public class LongestPath
    {
        ...
        //得到变量
        public GRBVar Get_var_by_name(string var_name)
        {
            return model.GetVarByName(var_name);
        }
        //得到下一个接续的列车
        ...
        //返回一条动车组交路
        public Algorithm.Path SolveResult()
        {
            ...
            if (optimstatus == GRB.Status.OPTIMAL)
            {
                ...
                return path;
                //调整后运行图显示
                //PaintClass.PaintStyle paintstyle = new PaintClass.PaintStyle(false, false, false, false, false, path);
